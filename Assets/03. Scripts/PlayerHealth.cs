...
public class PlayerHealth : MonoBehaviour
{
    ...
    private PlayerMovement playMovement; // 죽은 후 움직이지 않게 처리 함
    private PlayerShooting playShooting; // 죽은 후 총 발사 않게 함.
    ...
    private void Awake()
    {
        ...
        playShooting = GetComponentInChildren<PlayerShooting>(); // 자식 오브젝트까지 탐색 
    }
